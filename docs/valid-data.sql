...
(1, 'Рождество', 2011, ''),
(2, 'Жили-были', 2009, ''),
(3, 'Наш первый альбом', 2006, '
<p>Альбом записанный группой по следам своих выступлений на Невском проспекте в городе Санкт-Петербург. Совершенно случайным образом музыканты вдруг решили собраться и поиграть на улице именно группой. К тому времени у всех нынешних участников группы уже был богатый опыт уличных выступлений, но в основном заграницей. Первый совместный опыт игры в Петербурге на улице группой оказался настолько позитивным, что с этого момента Отава ё стали регулярно выступать около гомеопатический аптеки на Невском проспекте. Отсюда и название альбома — «Под аптекой».</p>
