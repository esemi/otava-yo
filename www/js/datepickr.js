...
var datepickr = (function() {
	...
	return function(elementId, userConfig) {
		...
		this.currentMonthView = (this.config.currentMonth !== null) ? this.config.currentMonth : date.current.month.integer();
		this.currentYearView = (this.config.currentYear !== null) ? this.config.currentYear : date.current.year();
